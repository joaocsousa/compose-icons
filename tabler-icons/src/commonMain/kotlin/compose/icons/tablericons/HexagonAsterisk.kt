...
public val TablerIcons.HexagonAsterisk: ImageVector
    get() {
        if (_hexagonAsterisk != null) {
            return _hexagonAsterisk!!
        }
        _hexagonAsterisk = Builder(name = "HexagonAsterisk", defaultWidth = 24.0.dp, defaultHeight =

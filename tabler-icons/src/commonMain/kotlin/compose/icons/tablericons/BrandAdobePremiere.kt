...
public val TablerIcons.BrandAdobePremiere: ImageVector
    get() {
        if (_brandAdobePremiere != null) {
            return _brandAdobePremiere!!
        }
        _brandAdobePremiere = Builder(name = "BrandAdobePremiere", defaultWidth = 24.0.dp,

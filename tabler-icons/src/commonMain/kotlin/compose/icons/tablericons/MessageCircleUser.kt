...
public val TablerIcons.MessageCircleUser: ImageVector
    get() {
        if (_messageCircleUser != null) {
            return _messageCircleUser!!
        }
        _messageCircleUser = Builder(name = "MessageCircleUser", defaultWidth = 24.0.dp,
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(9.9f, 9.9f, 0.0f, false, true, -4.754f, -0.97f)

...
public val TablerIcons.Sparkles2Off: ImageVector
    get() {
        if (_sparkles2Off != null) {
            return _sparkles2Off!!
        }
        _sparkles2Off = Builder(name = "Sparkles2Off", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
                moveTo(14.756f, 14.77f)
                curveToRelative(-2.16f, 0.93f, -3.34f, 2.207f, -4.224f, 4.568f)
                ...
                arcToRelative(21.0f, 21.0f, 0.0f, false, false, 1.652f, -0.532f)
                curveToRelative(2.345f, -0.879f, 3.642f, -2.04f, 4.585f, -4.23f)
            }
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                    strokeLineWidth = 2.0f, strokeLineCap = Round, strokeLineJoin =
                    StrokeJoin.Companion.Round, strokeLineMiter = 4.0f, pathFillType = NonZero) {
...
private var _sparkles2Off: ImageVector? = null

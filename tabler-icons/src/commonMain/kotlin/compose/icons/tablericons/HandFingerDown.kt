...
public val TablerIcons.HandFingerDown: ImageVector
    get() {
        if (_handFingerDown != null) {
            return _handFingerDown!!
        }
        _handFingerDown = Builder(name = "HandFingerDown", defaultWidth = 24.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0x00000000)), stroke = SolidColor(Color(0xFF000000)),
                ...
                arcToRelative(6.0f, 6.0f, 0.0f, false, false, -5.012f, 2.7f)
                lineToRelative(-0.196f, 0.3f)
                quadToRelative(-0.468f, 0.718f, -3.286f, 5.728f)
                arcToRelative(1.5f, 1.5f, 0.0f, false, false, 0.536f, 2.022f)

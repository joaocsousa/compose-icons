...
public val TablerIcons.BrandAdobeAfterEffects: ImageVector
    get() {
        if (_brandAdobeAfterEffects != null) {
            return _brandAdobeAfterEffects!!
        }
        _brandAdobeAfterEffects = Builder(name = "BrandAdobeAfterEffects", defaultWidth = 24.0.dp,
...
private var _brandAdobeAfterEffects: ImageVector? = null

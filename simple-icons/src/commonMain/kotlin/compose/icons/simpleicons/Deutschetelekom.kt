...
public val SimpleIcons.Deutschetelekom: ImageVector
    get() {
        if (_deutschetelekom != null) {
            return _deutschetelekom!!
        }
        _deutschetelekom = Builder(name = "Deutschetelekom", defaultWidth = 24.0.dp, defaultHeight =
...
private var _deutschetelekom: ImageVector? = null

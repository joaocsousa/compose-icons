...
public val SimpleIcons.Rstudioide: ImageVector
    get() {
        if (_rstudioide != null) {
            return _rstudioide!!
        }
        _rstudioide = Builder(name = "Rstudioide", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _rstudioide: ImageVector? = null

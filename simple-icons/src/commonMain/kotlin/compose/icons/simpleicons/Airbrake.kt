...
public val SimpleIcons.Airbrake: ImageVector
    get() {
        if (_airbrake != null) {
            return _airbrake!!
        }
        _airbrake = Builder(name = "Airbrake", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _airbrake: ImageVector? = null

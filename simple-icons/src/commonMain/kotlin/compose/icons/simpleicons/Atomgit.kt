...
public val SimpleIcons.Atomgit: ImageVector
    get() {
        if (_atomgit != null) {
            return _atomgit!!
        }
        _atomgit = Builder(name = "Atomgit", defaultWidth = 24.0.dp, defaultHeight = 24.0.dp,
...
private var _atomgit: ImageVector? = null

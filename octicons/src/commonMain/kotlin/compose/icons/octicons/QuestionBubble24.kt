...
public val Octicons.QuestionBubble24: ImageVector
    get() {
        if (_questionBubble24 != null) {
            return _questionBubble24!!
        }
        _questionBubble24 = Builder(name = "QuestionBubble24", defaultWidth = 24.0.dp, defaultHeight
                = 24.0.dp, viewportWidth = 24.0f, viewportHeight = 24.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(2.002f, 16.586f)
                lineTo(0.796f, 22.315f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, 0.889f, 0.889f)
                lineToRelative(5.729f, -1.206f)
                arcToRelative(11.0f, 11.0f, 0.0f, true, false, -5.412f, -5.412f)
                moveToRelative(1.519f, 0.062f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, -0.056f, -0.476f)
                lineToRelative(-0.099f, -0.209f)
                arcToRelative(9.5f, 9.5f, 0.0f, true, true, 4.671f, 4.671f)
                lineToRelative(-0.209f, -0.099f)
                arcToRelative(0.75f, 0.75f, 0.0f, false, false, -0.476f, -0.056f)
                lineToRelative(-4.851f, 1.02f)
                close()
                ...
                arcToRelative(4.0f, 4.0f, 0.0f, false, false, -0.435f, 0.409f)
                ...
                arcToRelative(0.95f, 0.95f, 0.0f, false, false, -0.404f, -0.806f)
...
private var _questionBubble24: ImageVector? = null

...
public val RegularGroup.DriversLicense: ImageVector
    get() {
        if (_driversLicense != null) {
            return _driversLicense!!
        }
        _driversLicense = Builder(name = "DriversLicense", defaultWidth = 576.0.dp, defaultHeight =
...
private var _driversLicense: ImageVector? = null

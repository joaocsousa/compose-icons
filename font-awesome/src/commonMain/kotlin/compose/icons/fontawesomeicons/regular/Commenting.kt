...
public val RegularGroup.Commenting: ImageVector
    get() {
        if (_commenting != null) {
            return _commenting!!
        }
        _commenting = Builder(name = "Commenting", defaultWidth = 512.0.dp, defaultHeight =
...
private var _commenting: ImageVector? = null

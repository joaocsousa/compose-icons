...
public val RegularGroup.ClockFour: ImageVector
    get() {
        if (_clockFour != null) {
            return _clockFour!!
        }
        _clockFour = Builder(name = "ClockFour", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
...
private var _clockFour: ImageVector? = null

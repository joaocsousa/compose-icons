    ...
    get() {
        ...
        _circleQuestion = Builder(name = "CircleQuestion", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 47.2f, -36.0f, 67.2f, -56.0f, 74.5f)
                lineToRelative(0.0f, 3.8f)
                curveToRelative(0.0f, 13.3f, -10.7f, 24.0f, -24.0f, 24.0f)
                reflectiveCurveToRelative(-24.0f, -10.7f, -24.0f, -24.0f)
                lineToRelative(0.0f, -8.1f)
                curveToRelative(0.0f, -20.5f, 14.8f, -35.2f, 30.1f, -40.2f)
                curveToRelative(6.4f, -2.1f, 13.2f, -5.5f, 18.2f, -10.3f)
                curveToRelative(4.3f, -4.2f, 7.7f, -10.0f, 7.7f, -19.6f)

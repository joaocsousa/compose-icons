...
public val RegularGroup.HospitalWide: ImageVector
    get() {
        if (_hospitalWide != null) {
            return _hospitalWide!!
        }
        _hospitalWide = Builder(name = "HospitalWide", defaultWidth = 576.0.dp, defaultHeight =
...
private var _hospitalWide: ImageVector? = null

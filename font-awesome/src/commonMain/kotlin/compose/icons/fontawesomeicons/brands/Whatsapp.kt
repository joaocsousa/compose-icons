    ...
    get() {
        ...
        _whatsapp = Builder(name = "Whatsapp", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(56.2f, 81.2f, 56.1f, 130.5f)
                ...
                reflectiveCurveToRelative(-14.3f, 18.0f, -17.6f, 21.8f)
                ...
                reflectiveCurveToRelative(-12.5f, -30.1f, -17.1f, -41.2f)
                curveToRelative(-4.5f, -10.8f, -9.1f, -9.3f, -12.5f, -9.5f)
                curveToRelative(-3.2f, -0.2f, -6.9f, -0.2f, -10.6f, -0.2f)
                reflectiveCurveToRelative(-9.7f, 1.4f, -14.8f, 6.9f)
                curveToRelative(-5.1f, 5.6f, -19.4f, 19.0f, -19.4f, 46.3f)
                reflectiveCurveToRelative(19.9f, 53.7f, 22.6f, 57.4f)
                ...
                reflectiveCurveToRelative(4.6f, -24.1f, 3.2f, -26.4f)

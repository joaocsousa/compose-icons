    ...
    get() {
        ...
        _asymmetrik = Builder(name = "Asymmetrik", defaultWidth = 576.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-128.7f, -19.7f, -288.5f, 15.5f, -406.6f, 82.4f)
                curveToRelative(52.0f, -26.5f, 110.6f, -48.2f, 170.7f, -58.2f)
                curveToRelative(74.5f, -20.5f, 153.0f, -25.4f, 221.3f, -14.8f)
                curveToRelative(152.5f, 23.8f, 196.8f, 127.5f, 98.8f, 231.7f)

    ...
    get() {
        ...
        _ups = Builder(name = "Ups", defaultWidth = 384.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(263.1f, 13.2f, 97.6f, 25.2f, 4.0f, 74.8f)
                close()
                moveTo(362.1f, 295.7f)
                ...
                close()
                moveTo(152.5f, 188.3f)
                lineToRelative(0.0f, 212.8f)
                lineToRelative(32.7f, 0.0f)
                lineToRelative(0.0f, -68.7f)
                curveToRelative(24.4f, 7.3f, 71.7f, -2.6f, 71.7f, -78.5f)
                curveToRelative(0.0f, -97.4f, -80.7f, -80.9f, -104.4f, -65.6f)
                close()
                moveTo(185.2f, 305.6f)

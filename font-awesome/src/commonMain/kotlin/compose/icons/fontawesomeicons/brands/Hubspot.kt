    ...
    get() {
        ...
        _hubspot = Builder(name = "Hubspot", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(279.6f, 47.0f, 279.6f, 73.1f)
                ...
                curveToRelative(0.0f, -28.8f, -23.5f, -52.2f, -52.4f, -52.2f)
                curveToRelative(-28.8f, 0.0f, -52.2f, 23.4f, -52.2f, 52.2f)
                curveToRelative(0.0f, 28.9f, 23.4f, 52.3f, 52.2f, 52.3f)
                curveToRelative(9.8f, 0.0f, 18.9f, -2.9f, 26.8f, -7.6f)
                lineTo(235.8f, 211.6f)
                close()
                moveTo(325.3f, 237.2f)
                arcToRelative(69.0f, 69.0f, 0.0f, true, true, 0.0f, 138.0f)
                arcToRelative(69.0f, 69.0f, 0.0f, true, true, 0.0f, -138.0f)
                close()
            }
        }

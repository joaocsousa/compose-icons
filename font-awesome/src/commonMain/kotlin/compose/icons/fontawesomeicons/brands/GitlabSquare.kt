...
public val BrandsGroup.GitlabSquare: ImageVector
    get() {
        if (_gitlabSquare != null) {
            return _gitlabSquare!!
        }
        _gitlabSquare = Builder(name = "GitlabSquare", defaultWidth = 448.0.dp, defaultHeight =
...
private var _gitlabSquare: ImageVector? = null

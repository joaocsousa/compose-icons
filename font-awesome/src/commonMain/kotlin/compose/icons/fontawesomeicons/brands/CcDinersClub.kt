    ...
    get() {
        ...
        _ccDinersClub = Builder(name = "CcDinersClub", defaultWidth = 576.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(239.7f, 79.9f)
                arcToRelative(175.8f, 175.8f, 0.0f, true, false, 0.0f, 351.6f)
                arcToRelative(175.8f, 175.8f, 0.0f, true, false, 0.0f, -351.6f)
                close()
                ...
                lineToRelative(0.0f, 207.9f)
                close()
                moveTo(279.6f, 359.8f)
                lineToRelative(0.0f, -208.2f)
                ...
                curveTo(133.2f, 448.0f, 45.6f, 362.5f, 45.6f, 257.8f)

...
public val BrandsGroup.SquareKickstarter: ImageVector
    get() {
        if (_squareKickstarter != null) {
            return _squareKickstarter!!
        }
        _squareKickstarter = Builder(name = "SquareKickstarter", defaultWidth = 448.0.dp,
...
private var _squareKickstarter: ImageVector? = null

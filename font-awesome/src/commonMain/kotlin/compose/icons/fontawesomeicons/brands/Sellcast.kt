    ...
    get() {
        ...
        _sellcast = Builder(name = "Sellcast", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(353.5f, 32.0f)
                lineTo(94.8f, 32.0f)
                curveTo(42.7f, 32.0f, 0.1f, 74.6f, 0.1f, 126.6f)
                lineToRelative(0.0f, 258.7f)
                curveTo(0.1f, 437.4f, 42.7f, 480.0f, 94.8f, 480.0f)
                lineToRelative(258.7f, 0.0f)
                curveToRelative(52.1f, 0.0f, 94.7f, -42.6f, 94.7f, -94.6f)
                lineToRelative(0.0f, -258.8f)
                curveToRelative(0.0f, -52.0f, -42.6f, -94.6f, -94.7f, -94.6f)
                close()
                moveTo(303.5f, 348.4f)

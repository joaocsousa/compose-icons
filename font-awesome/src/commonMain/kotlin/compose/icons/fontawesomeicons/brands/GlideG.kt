    ...
    get() {
        ...
        _glideG = Builder(name = "GlideG", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, -71.5f, -38.2f, -100.6f, -108.4f, -100.6f)
                curveToRelative(-115.1f, 0.0f, -173.4f, 113.7f, -173.4f, 198.4f)
                curveToRelative(0.0f, 87.9f, 51.3f, 136.6f, 138.6f, 136.6f)
                ...
                curveToRelative(0.0f, 51.9f, 32.8f, 87.9f, 85.5f, 87.9f)

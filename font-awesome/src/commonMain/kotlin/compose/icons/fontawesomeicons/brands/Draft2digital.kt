...
public val BrandsGroup.Draft2digital: ImageVector
    get() {
        ...
        _draft2digital = Builder(name = "Draft2digital", defaultWidth = 512.0.dp, defaultHeight =
                512.0.dp, viewportWidth = 512.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(496.0f, 398.1f)
                ...
                curveToRelative(-76.6f, 87.0f, -142.8f, 155.7f, -161.1f, 174.8f)
                lineToRelative(336.0f, -0.1f)
                lineToRelative(0.0f, 64.2f)
                lineToRelative(144.0f, -81.9f)
                close()
                moveTo(385.9f, 371.0f)
                lineToRelative(47.1f, 27.2f)
                lineToRelative(-47.1f, 27.2f)
                lineToRelative(0.0f, -54.4f)
                close()
                moveTo(105.4f, 161.4f)

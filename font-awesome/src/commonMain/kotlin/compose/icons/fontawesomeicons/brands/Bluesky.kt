    ...
    get() {
        ...
        _bluesky = Builder(name = "Bluesky", defaultWidth = 576.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-93.9f, 14.0f, -177.3f, 48.2f, -67.9f, 169.9f)
                curveToRelative(120.3f, 124.6f, 164.8f, -26.7f, 187.7f, -103.4f)
                ...
                curveToRelative(5.9f, -19.9f, 15.0f, -138.9f, 15.0f, -155.5f)
                reflectiveCurveToRelative(-3.3f, -44.7f, -21.6f, -52.9f)
                curveToRelative(-15.8f, -7.1f, -40.0f, -14.9f, -103.2f, 29.8f)
                curveToRelative(-66.1f, 46.6f, -137.1f, 141.1f, -163.2f, 191.8f)
                close()
            }
        }
        .build()

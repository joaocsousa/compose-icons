    ...
    get() {
        ...
        _amilia = Builder(name = "Amilia", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(203.1f, 227.7f, 78.3f, 251.0f, 46.8f, 264.2f)
                curveTo(11.3f, 280.5f, 16.4f, 357.7f, 16.4f, 376.0f)
                reflectiveCurveTo(31.6f, 480.0f, 141.3f, 480.0f)

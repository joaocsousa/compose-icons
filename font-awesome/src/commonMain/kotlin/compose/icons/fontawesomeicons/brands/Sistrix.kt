    ...
    get() {
        ...
        _sistrix = Builder(name = "Sistrix", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-91.9f, -0.1f, -166.6f, 75.7f, -166.6f, 168.8f)
                reflectiveCurveTo(74.7f, 369.8f, 166.5f, 369.8f)
                curveToRelative(39.8f, 0.0f, 76.3f, -14.2f, 105.0f, -37.9f)
                lineTo(417.5f, 480.0f)
                lineTo(448.0f, 449.0f)
                close()
                moveTo(166.5f, 330.8f)
                curveToRelative(-70.6f, 0.0f, -128.1f, -58.3f, -128.1f, -129.9f)
                reflectiveCurveTo(95.9f, 71.0f, 166.5f, 71.0f)
                reflectiveCurveTo(294.6f, 129.3f, 294.6f, 200.9f)
                reflectiveCurveTo(237.2f, 330.8f, 166.5f, 330.8f)
                close()
            }
        }
        .build()

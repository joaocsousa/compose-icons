...
public val BrandsGroup.SquareWebAwesomeStroke: ImageVector
    get() {
        if (_squareWebAwesomeStroke != null) {
            return _squareWebAwesomeStroke!!
        }
        _squareWebAwesomeStroke = Builder(name = "SquareWebAwesomeStroke", defaultWidth = 448.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(87.2f, 224.0f)
                curveToRelative(-12.9f, -0.4f, -23.2f, -11.0f, -23.2f, -24.0f)
                curveToRelative(0.0f, -13.3f, 10.7f, -24.0f, 24.0f, -24.0f)
                reflectiveCurveToRelative(24.0f, 10.7f, 24.0f, 24.0f)
                curveToRelative(0.0f, 5.0f, -1.5f, 9.7f, -4.2f, 13.6f)
                lineTo(160.0f, 224.0f)
                lineTo(213.1f, 177.6f)
...
private var _squareWebAwesomeStroke: ImageVector? = null

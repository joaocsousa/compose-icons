    ...
    get() {
        ...
        _playstation = Builder(name = "Playstation", defaultWidth = 576.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(571.0f, 372.3f)
                curveToRelative(-11.3f, 14.2f, -38.8f, 24.3f, -38.8f, 24.3f)
                lineToRelative(-205.1f, 73.6f)
                lineToRelative(0.0f, -54.3f)
                ...
                lineToRelative(0.0f, -414.7f)
                curveToRelative(39.9f, 7.4f, 98.0f, 24.9f, 129.2f, 35.4f)
                curveToRelative(79.5f, 27.3f, 106.4f, 61.3f, 106.4f, 137.8f)
                ...
                reflectiveCurveToRelative(39.1f, 3.3f, 56.2f, -2.9f)

    ...
    get() {
        ...
        _audible = Builder(name = "Audible", defaultWidth = 640.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(-135.5f, 36.7f, -172.6f, 92.4f)
                ...
                curveTo(235.4f, 56.8f, 421.8f, 84.7f, 521.1f, 223.2f)
                lineToRelative(0.7f, 1.0f)
                lineToRelative(48.8f, -30.4f)
                curveToRelative(-53.5f, -81.7f, -145.8f, -135.7f, -250.7f, -135.7f)

    ...
    get() {
        ...
        _squareOdnoklassniki = Builder(name = "SquareOdnoklassniki", defaultWidth = 448.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-5.4f, -0.3f, -10.8f, 0.6f, -15.9f, 2.4f)
                reflectiveCurveToRelative(-9.7f, 4.8f, -13.6f, 8.5f)
                reflectiveCurveToRelative(-7.0f, 8.2f, -9.2f, 13.2f)
                reflectiveCurveToRelative(-3.2f, 10.3f, -3.2f, 15.7f)
                reflectiveCurveToRelative(1.1f, 10.8f, 3.2f, 15.7f)
                reflectiveCurveToRelative(5.3f, 9.5f, 9.2f, 13.2f)
                reflectiveCurveToRelative(8.6f, 6.6f, 13.6f, 8.5f)
                reflectiveCurveToRelative(10.5f, 2.7f, 15.9f, 2.4f)
                curveToRelative(5.4f, 0.3f, 10.8f, -0.6f, 15.9f, -2.4f)
                reflectiveCurveToRelative(9.7f, -4.8f, 13.6f, -8.5f)
                reflectiveCurveToRelative(7.0f, -8.2f, 9.2f, -13.2f)
                reflectiveCurveToRelative(3.2f, -10.3f, 3.2f, -15.7f)

    ...
    get() {
        ...
        _ubuntu = Builder(name = "Ubuntu", defaultWidth = 576.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(469.2f, 75.0f)
                curveToRelative(0.0f, -20.1f, -8.0f, -39.3f, -22.2f, -53.5f)
                reflectiveCurveToRelative(-33.4f, -22.2f, -53.5f, -22.2f)
                reflectiveCurveToRelative(-39.3f, 8.0f, -53.5f, 22.2f)
                reflectiveCurveToRelative(-22.2f, 33.4f, -22.2f, 53.5f)
                curveToRelative(0.0f, 20.1f, 8.0f, 39.3f, 22.1f, 53.5f)
                reflectiveCurveToRelative(33.4f, 22.1f, 53.5f, 22.1f)
                reflectiveCurveToRelative(39.3f, -8.0f, 53.5f, -22.1f)
                reflectiveCurveToRelative(22.1f, -33.4f, 22.1f, -53.5f)
                ...
                close()
                moveTo(57.0f, 346.0f)
                curveToRelative(18.6f, 46.9f, 51.0f, 87.0f, 93.0f, 115.1f)

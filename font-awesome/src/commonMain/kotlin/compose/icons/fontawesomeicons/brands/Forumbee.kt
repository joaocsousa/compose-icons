    ...
    get() {
        ...
        _forumbee = Builder(name = "Forumbee", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(239.7f, 35.0f, 256.4f, 37.0f, 272.4f, 40.5f)
                curveTo(149.0f, 87.5f, 51.9f, 186.0f, 5.8f, 309.7f)
                close()
                moveTo(398.7f, 120.5f)
                curveToRelative(-13.7f, -17.5f, -29.7f, -32.7f, -47.8f, -45.3f)
                ...
                curveToRelative(-137.9f, 45.8f, -246.4f, 156.6f, -291.3f, 295.1f)
                curveToRelative(18.1f, 7.6f, 37.0f, 12.5f, 56.6f, 15.2f)
                curveToRelative(46.3f, -114.1f, 136.8f, -206.8f, 250.5f, -253.5f)
                close()
            }
        }
        .build()

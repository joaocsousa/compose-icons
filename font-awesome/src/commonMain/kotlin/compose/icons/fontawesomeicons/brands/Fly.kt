...
public val BrandsGroup.Fly: ImageVector
    get() {
        ...
        _fly = Builder(name = "Fly", defaultWidth = 320.0.dp, defaultHeight = 512.0.dp,
                viewportWidth = 320.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(165.9f, 427.8f)
                ...
                curveToRelative(-25.5f, -10.7f, -54.6f, -15.4f, -76.6f, -15.2f)
                curveToRelative(-44.1f, 0.0f, -71.2f, 13.2f, -81.1f, 17.3f)
                curveToRelative(-53.6f, 27.9f, -84.4f, 69.9f, -82.9f, 141.3f)

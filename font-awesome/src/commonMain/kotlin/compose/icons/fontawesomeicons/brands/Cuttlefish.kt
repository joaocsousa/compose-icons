...
public val BrandsGroup.Cuttlefish: ImageVector
    get() {
        ...
        _cuttlefish = Builder(name = "Cuttlefish", defaultWidth = 448.0.dp, defaultHeight =
                512.0.dp, viewportWidth = 448.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(348.0f, 305.5f)
                ...
                curveToRelative(-45.3f, -49.6f, -110.5f, -80.7f, -183.0f, -80.7f)
                curveToRelative(-137.0f, 0.0f, -248.0f, 111.0f, -248.0f, 248.0f)
                reflectiveCurveTo(115.0f, 504.0f, 252.0f, 504.0f)

    ...
    get() {
        ...
        _itunes = Builder(name = "Itunes", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(223.6f, 80.3f)
                arcToRelative(171.3f, 171.3f, 0.0f, true, false, 0.2f, 342.5f)
                arcToRelative(171.3f, 171.3f, 0.0f, true, false, -0.2f, -342.5f)
                close()
                ...
                lineToRelative(242.4f, 0.0f)
                curveToRelative(57.0f, 0.0f, 102.8f, -45.9f, 102.8f, -102.8f)
                lineToRelative(0.0f, -242.4f)
                curveTo(448.0f, 77.9f, 402.1f, 32.0f, 345.2f, 32.0f)
                close()
                moveTo(223.6f, 59.0f)
                arcToRelative(192.5f, 192.5f, 0.0f, true, true, 0.0f, 385.0f)
                arcToRelative(192.5f, 192.5f, 0.0f, true, true, 0.0f, -385.0f)
                close()
            }
        }

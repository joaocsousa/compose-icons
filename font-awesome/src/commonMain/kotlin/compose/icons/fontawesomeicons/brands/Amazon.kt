    ...
    get() {
        ...
        _amazon = Builder(name = "Amazon", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(-32.3f, -25.3f, -32.3f, -52.8f)
                lineToRelative(0.0f, -147.1f)
                curveTo(341.5f, 89.0f, 317.0f, 32.0f, 229.2f, 32.0f)
                curveTo(141.2f, 32.0f, 94.5f, 87.0f, 94.5f, 136.3f)

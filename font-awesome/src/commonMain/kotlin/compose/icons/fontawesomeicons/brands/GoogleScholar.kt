    ...
    get() {
        ...
        _googleScholar = Builder(name = "GoogleScholar", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-0.1f, 82.5f, -66.9f, 149.4f, -149.4f, 149.4f)
                reflectiveCurveTo(106.7f, 445.1f, 106.7f, 362.7f)
                ...
                lineToRelative(-94.7f, -77.0f)
                lineToRelative(256.0f, -202.7f)
                lineToRelative(256.0f, 202.7f)

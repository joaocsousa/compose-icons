    ...
    get() {
        ...
        _uikit = Builder(name = "Uikit", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-225.9f, 128.0f)
                lineToRelative(-218.0f, -128.0f)
                lineToRelative(0.0f, -214.3f)
                lineToRelative(87.6f, 45.1f)
                lineToRelative(0.0f, 117.0f)
                lineToRelative(133.5f, 75.5f)
                lineToRelative(135.8f, -75.5f)
                lineToRelative(0.0f, -151.0f)
                lineToRelative(-101.1f, -57.6f)
                lineToRelative(87.6f, -53.1f)
                lineToRelative(100.5f, 57.9f)
                close()
                moveTo(308.6f, 49.1f)
                lineToRelative(-84.8f, -49.1f)

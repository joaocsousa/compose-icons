...
public val SolidGroup.ChainBroken: ImageVector
    get() {
        if (_chainBroken != null) {
            return _chainBroken!!
        }
        _chainBroken = Builder(name = "ChainBroken", defaultWidth = 576.0.dp, defaultHeight =
...
private var _chainBroken: ImageVector? = null

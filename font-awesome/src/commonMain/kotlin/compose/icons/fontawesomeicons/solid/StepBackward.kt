...
public val SolidGroup.StepBackward: ImageVector
    get() {
        ...
        _stepBackward = Builder(name = "StepBackward", defaultWidth = 384.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveToRelative(21.0f, -20.5f, 21.0f, -35.2f)
                lineToRelative(0.0f, -368.0f)
                curveToRelative(0.0f, -14.7f, -8.1f, -28.2f, -21.0f, -35.2f)
                close()
            }
        }
        .build()

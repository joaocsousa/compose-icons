    ...
    get() {
        ...
        _oilWell = Builder(name = "OilWell", defaultWidth = 576.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(17.7f, 0.0f, 32.0f, -14.3f, 32.0f, -32.0f)
                reflectiveCurveToRelative(-14.3f, -32.0f, -32.0f, -32.0f)
                lineToRelative(-137.3f, 0.0f)
                lineToRelative(-61.4f, -175.4f)
                lineToRelative(-62.2f, 16.1f)
                lineToRelative(22.1f, 63.2f)
                lineToRelative(-66.6f, 0.0f)
                lineToRelative(19.9f, -56.9f)
                lineToRelative(-74.6f, 19.3f)
                lineToRelative(-46.7f, 133.5f)
                lineToRelative(-41.3f, 0.0f)
                lineToRelative(0.0f, -159.2f)
                ...
                lineToRelative(16.8f, -48.0f)
                lineToRelative(100.2f, 0.0f)
                lineToRelative(16.8f, 48.0f)
                lineToRelative(-133.8f, 0.0f)
                close()
            }
        }
        .build()

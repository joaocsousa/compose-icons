...
public val SolidGroup.ChainSlash: ImageVector
    get() {
        if (_chainSlash != null) {
            return _chainSlash!!
        }
        _chainSlash = Builder(name = "ChainSlash", defaultWidth = 576.0.dp, defaultHeight =
...
private var _chainSlash: ImageVector? = null

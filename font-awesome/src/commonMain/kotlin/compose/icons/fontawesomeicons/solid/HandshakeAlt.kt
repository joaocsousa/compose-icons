...
public val SolidGroup.HandshakeAlt: ImageVector
    get() {
        if (_handshakeAlt != null) {
            return _handshakeAlt!!
        }
        _handshakeAlt = Builder(name = "HandshakeAlt", defaultWidth = 576.0.dp, defaultHeight =
...
private var _handshakeAlt: ImageVector? = null

...
public val SolidGroup.RodAsclepius: ImageVector
    get() {
        if (_rodAsclepius != null) {
            return _rodAsclepius!!
        }
        _rodAsclepius = Builder(name = "RodAsclepius", defaultWidth = 448.0.dp, defaultHeight =
...
private var _rodAsclepius: ImageVector? = null

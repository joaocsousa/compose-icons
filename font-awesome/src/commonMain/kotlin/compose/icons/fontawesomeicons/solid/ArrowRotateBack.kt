...
public val SolidGroup.ArrowRotateBack: ImageVector
    get() {
        if (_arrowRotateBack != null) {
            return _arrowRotateBack!!
        }
        _arrowRotateBack = Builder(name = "ArrowRotateBack", defaultWidth = 512.0.dp, defaultHeight
...
private var _arrowRotateBack: ImageVector? = null

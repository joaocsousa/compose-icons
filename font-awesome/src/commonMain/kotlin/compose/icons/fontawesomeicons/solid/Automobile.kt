...
public val SolidGroup.Automobile: ImageVector
    get() {
        if (_automobile != null) {
            return _automobile!!
        }
        _automobile = Builder(name = "Automobile", defaultWidth = 512.0.dp, defaultHeight =

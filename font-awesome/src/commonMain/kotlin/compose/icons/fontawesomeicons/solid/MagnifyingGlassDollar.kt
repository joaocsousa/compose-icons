...
public val SolidGroup.MagnifyingGlassDollar: ImageVector
    get() {
        if (_magnifyingGlassDollar != null) {
            return _magnifyingGlassDollar!!
        }
        _magnifyingGlassDollar = Builder(name = "MagnifyingGlassDollar", defaultWidth = 512.0.dp,
...
private var _magnifyingGlassDollar: ImageVector? = null

...
public val SolidGroup.Teletype: ImageVector
    get() {
        if (_teletype != null) {
            return _teletype!!
        }
        _teletype = Builder(name = "Teletype", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
...
private var _teletype: ImageVector? = null

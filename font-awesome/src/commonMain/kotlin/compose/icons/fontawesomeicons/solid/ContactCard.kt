...
public val SolidGroup.ContactCard: ImageVector
    get() {
        if (_contactCard != null) {
            return _contactCard!!
        }
        _contactCard = Builder(name = "ContactCard", defaultWidth = 576.0.dp, defaultHeight =

...
public val SolidGroup.DollyBox: ImageVector
    get() {
        if (_dollyBox != null) {
            return _dollyBox!!
        }
        _dollyBox = Builder(name = "DollyBox", defaultWidth = 576.0.dp, defaultHeight = 512.0.dp,
...
private var _dollyBox: ImageVector? = null

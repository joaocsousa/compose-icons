    ...
    get() {
        ...
        _balanceScaleRight = Builder(name = "BalanceScaleRight", defaultWidth = 640.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(118.2f, 62.4f)
                curveTo(101.5f, 56.8f, 92.4f, 38.6f, 98.0f, 21.9f)
                reflectiveCurveTo(121.7f, -3.9f, 138.5f, 1.6f)
                ...
                close()
                moveTo(200.8f, 288.0f)
                lineTo(128.3f, 163.8f)
                lineTo(55.9f, 288.0f)
                lineTo(200.8f, 288.0f)
                close()
                moveTo(128.4f, 384.0f)
                ...
                close()
                moveTo(511.2f, 291.8f)
                lineToRelative(-72.4f, 124.2f)
                lineToRelative(144.9f, 0.0f)
                lineToRelative(-72.4f, -124.2f)
                close()
                moveTo(637.2f, 433.1f)
                curveTo(626.4f, 478.0f, 574.1f, 512.0f, 511.2f, 512.0f)

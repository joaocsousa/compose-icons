...
public val SolidGroup.Hourglass3: ImageVector
    get() {
        if (_hourglass3 != null) {
            return _hourglass3!!
        }
        _hourglass3 = Builder(name = "Hourglass3", defaultWidth = 384.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(0.0f, -11.0f)
                curveToRelative(17.7f, 0.0f, 32.0f, -14.3f, 32.0f, -32.0f)
                reflectiveCurveTo(369.7f, 0.0f, 352.0f, 0.0f)
                lineTo(32.0f, 0.0f)
                close()
                moveTo(96.0f, 75.0f)
                lineToRelative(0.0f, -11.0f)

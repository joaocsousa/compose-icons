...
public val SolidGroup.Deafness: ImageVector
    get() {
        if (_deafness != null) {
            return _deafness!!
        }
        _deafness = Builder(name = "Deafness", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
...
private var _deafness: ImageVector? = null

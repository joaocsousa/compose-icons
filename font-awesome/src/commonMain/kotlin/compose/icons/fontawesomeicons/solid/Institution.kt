...
public val SolidGroup.Institution: ImageVector
    get() {
        if (_institution != null) {
            return _institution!!
        }
        _institution = Builder(name = "Institution", defaultWidth = 512.0.dp, defaultHeight =
...
private var _institution: ImageVector? = null

    ...
    get() {
        ...
        _atom = Builder(name = "Atom", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(414.0f, 256.0f)
                curveToRelative(33.0f, 45.2f, 44.3f, 90.9f, 23.6f, 128.0f)
                curveToRelative(-20.2f, 36.3f, -62.5f, 49.3f, -115.2f, 43.2f)
                curveToRelative(-22.0f, 52.1f, -55.7f, 84.8f, -98.4f, 84.8f)
                reflectiveCurveToRelative(-76.4f, -32.7f, -98.4f, -84.8f)
                curveTo(72.9f, 433.3f, 30.6f, 420.3f, 10.4f, 384.0f)
                curveTo(-10.3f, 346.9f, 1.0f, 301.2f, 34.0f, 256.0f)
                curveTo(1.0f, 210.8f, -10.3f, 165.1f, 10.4f, 128.0f)
                curveTo(30.6f, 91.7f, 72.9f, 78.7f, 125.6f, 84.8f)
                curveTo(147.6f, 32.7f, 181.2f, 0.0f, 224.0f, 0.0f)
                reflectiveCurveToRelative(76.4f, 32.7f, 98.4f, 84.8f)
                curveToRelative(52.7f, -6.1f, 95.0f, 6.8f, 115.2f, 43.2f)
                curveToRelative(20.7f, 37.1f, 9.4f, 82.8f, -23.6f, 128.0f)
                close()
                moveTo(348.2f, 323.4f)
                ...
                close()
                moveTo(258.9f, 99.7f)
                curveTo(242.1f, 65.9f, 227.9f, 64.0f, 224.0f, 64.0f)
                reflectiveCurveToRelative(-18.1f, 1.9f, -34.9f, 35.7f)
                curveToRelative(11.4f, 3.9f, 23.1f, 8.4f, 34.9f, 13.5f)
                curveToRelative(11.8f, -5.1f, 23.4f, -9.7f, 34.9f, -13.5f)
                close()

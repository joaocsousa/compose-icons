...
public val SolidGroup.ArrowRotateBackward: ImageVector
    get() {
        if (_arrowRotateBackward != null) {
            return _arrowRotateBackward!!
        }
        _arrowRotateBackward = Builder(name = "ArrowRotateBackward", defaultWidth = 512.0.dp,
...
private var _arrowRotateBackward: ImageVector? = null

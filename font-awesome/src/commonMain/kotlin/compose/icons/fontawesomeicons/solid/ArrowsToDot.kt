    ...
    get() {
        ...
        _arrowsToDot = Builder(name = "ArrowsToDot", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(179.1f, 64.0f, 192.0f, 64.0f)
                lineToRelative(32.0f, 0.0f)
                lineToRelative(0.0f, -32.0f)
                ...
                lineToRelative(64.0f, 64.0f)
                curveToRelative(9.2f, 9.2f, 11.9f, 22.9f, 6.9f, 34.9f)
                reflectiveCurveTo(332.9f, 448.0f, 320.0f, 448.0f)
                lineToRelative(-32.0f, 0.0f)
                lineToRelative(0.0f, 32.0f)
                curveToRelative(0.0f, 17.7f, -14.3f, 32.0f, -32.0f, 32.0f)
                ...
                reflectiveCurveTo(64.0f, 332.9f, 64.0f, 320.0f)
                lineToRelative(0.0f, -32.0f)
                lineToRelative(-32.0f, 0.0f)
                curveToRelative(-17.7f, 0.0f, -32.0f, -14.3f, -32.0f, -32.0f)
                ...
                lineToRelative(64.0f, -64.0f)
                curveToRelative(9.2f, -9.2f, 22.9f, -11.9f, 34.9f, -6.9f)
                reflectiveCurveTo(448.0f, 179.1f, 448.0f, 192.0f)
                lineToRelative(0.0f, 32.0f)
                lineToRelative(32.0f, 0.0f)
                curveToRelative(17.7f, 0.0f, 32.0f, 14.3f, 32.0f, 32.0f)
                reflectiveCurveToRelative(-14.3f, 32.0f, -32.0f, 32.0f)

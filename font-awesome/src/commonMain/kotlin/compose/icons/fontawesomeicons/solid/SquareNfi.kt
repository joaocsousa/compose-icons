    ...
    get() {
        ...
        _squareNfi = Builder(name = "SquareNfi", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(93.0f, 172.3f)
                lineToRelative(35.0f, 63.0f)
                lineToRelative(0.0f, -51.4f)
                curveToRelative(0.0f, -13.3f, 10.7f, -24.0f, 24.0f, -24.0f)
                reflectiveCurveToRelative(24.0f, 10.7f, 24.0f, 24.0f)
                lineToRelative(0.0f, 144.0f)
                curveToRelative(0.0f, 10.9f, -7.4f, 20.5f, -18.0f, 23.2f)
                reflectiveCurveToRelative(-21.7f, -2.0f, -27.0f, -11.6f)
                lineToRelative(-35.0f, -63.0f)
                lineToRelative(0.0f, 51.4f)
                curveToRelative(0.0f, 13.3f, -10.7f, 24.0f, -24.0f, 24.0f)
                reflectiveCurveToRelative(-24.0f, -10.7f, -24.0f, -24.0f)

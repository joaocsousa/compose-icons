...
public val SolidGroup.ToiletPaperAlt: ImageVector
    get() {
        if (_toiletPaperAlt != null) {
            return _toiletPaperAlt!!
        }
        _toiletPaperAlt = Builder(name = "ToiletPaperAlt", defaultWidth = 512.0.dp, defaultHeight =
...
private var _toiletPaperAlt: ImageVector? = null

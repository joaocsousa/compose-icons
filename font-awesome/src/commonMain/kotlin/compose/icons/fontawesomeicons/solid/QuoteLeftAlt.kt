...
public val SolidGroup.QuoteLeftAlt: ImageVector
    get() {
        if (_quoteLeftAlt != null) {
            return _quoteLeftAlt!!
        }
        _quoteLeftAlt = Builder(name = "QuoteLeftAlt", defaultWidth = 448.0.dp, defaultHeight =
...
private var _quoteLeftAlt: ImageVector? = null

...
public val SolidGroup.MobileAndroidAlt: ImageVector
    get() {
        if (_mobileAndroidAlt != null) {
            return _mobileAndroidAlt!!
        }
        _mobileAndroidAlt = Builder(name = "MobileAndroidAlt", defaultWidth = 384.0.dp,
...
private var _mobileAndroidAlt: ImageVector? = null

    ...
    get() {
        ...
        _splotch = Builder(name = "Splotch", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveTo(316.5f, 0.0f, 341.6f, 18.7f, 349.8f, 46.0f)
                ...
                curveToRelative(-14.8f, 0.0f, -29.3f, -5.1f, -40.9f, -14.3f)
                lineToRelative(-55.3f, -44.3f)
                curveToRelative(-4.5f, -3.6f, -9.3f, -6.7f, -14.5f, -9.2f)
                curveToRelative(-15.8f, -7.9f, -33.7f, -10.4f, -51.0f, -7.3f)
                lineTo(82.4f, 451.9f)
                curveToRelative(-34.6f, 6.3f, -66.4f, -20.3f, -66.4f, -55.4f)
                ...
                curveTo(0.0f, 110.5f, 30.1f, 85.1f, 63.0f, 90.7f)

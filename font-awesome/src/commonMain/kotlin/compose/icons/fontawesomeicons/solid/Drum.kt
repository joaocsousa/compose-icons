    ...
    get() {
        ...
        _drum = Builder(name = "Drum", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(38.8f, 15.1f, 44.4f, 30.6f, 44.4f, 41.3f)
                curveToRelative(0.0f, 0.8f, -2.7f, 17.2f, -46.0f, 35.9f)
                curveToRelative(-38.9f, 16.8f, -96.0f, 28.1f, -162.0f, 28.1f)
                reflectiveCurveTo(132.9f, 260.7f, 94.0f, 243.9f)
                curveToRelative(-43.3f, -18.7f, -46.0f, -35.1f, -46.0f, -35.9f)
                curveToRelative(0.0f, -10.6f, 5.6f, -26.2f, 44.4f, -41.3f)
                curveToRelative(38.3f, -14.9f, 95.4f, -22.7f, 163.6f, -22.7f)

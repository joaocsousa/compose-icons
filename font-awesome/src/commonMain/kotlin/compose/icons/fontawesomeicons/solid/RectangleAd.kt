...
public val SolidGroup.RectangleAd: ImageVector
    get() {
        ...
        _rectangleAd = Builder(name = "RectangleAd", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(64.0f, 64.0f)
                close()
                moveTo(416.0f, 184.0f)
                lineToRelative(0.0f, 144.0f)
                curveToRelative(0.0f, 13.3f, -10.7f, 24.0f, -24.0f, 24.0f)
                curveToRelative(-7.1f, 0.0f, -13.5f, -3.1f, -17.9f, -8.0f)
                curveToRelative(-10.2f, 5.1f, -21.8f, 8.0f, -34.1f, 8.0f)
                curveToRelative(-42.0f, 0.0f, -76.0f, -34.0f, -76.0f, -76.0f)
                reflectiveCurveToRelative(34.0f, -76.0f, 76.0f, -76.0f)
                curveToRelative(9.9f, 0.0f, 19.3f, 1.9f, 28.0f, 5.3f)
                lineToRelative(0.0f, -21.3f)
                curveToRelative(0.0f, -13.3f, 10.7f, -24.0f, 24.0f, -24.0f)

    ...
    get() {
        ...
        _photoVideo = Builder(name = "PhotoVideo", defaultWidth = 640.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                arcToRelative(32.0f, 32.0f, 0.0f, true, false, 64.0f, 0.0f)
                close()
                moveTo(476.5f, 107.5f)
                curveTo(472.1f, 100.4f, 464.4f, 96.0f, 456.0f, 96.0f)
                reflectiveCurveToRelative(-16.1f, 4.4f, -20.5f, 11.5f)
                lineToRelative(-54.0f, 88.3f)
                lineToRelative(-17.9f, -25.6f)
                ...
                reflectiveCurveTo(279.1f, 288.0f, 288.0f, 288.0f)

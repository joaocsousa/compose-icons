...
public val SolidGroup.Thermometer3: ImageVector
    get() {
        if (_thermometer3 != null) {
            return _thermometer3!!
        }
        _thermometer3 = Builder(name = "Thermometer3", defaultWidth = 320.0.dp, defaultHeight =
...
private var _thermometer3: ImageVector? = null

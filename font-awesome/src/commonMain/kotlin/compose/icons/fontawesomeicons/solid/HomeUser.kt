...
public val SolidGroup.HomeUser: ImageVector
    get() {
        if (_homeUser != null) {
            return _homeUser!!
        }
        _homeUser = Builder(name = "HomeUser", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
...
private var _homeUser: ImageVector? = null

...
public val SolidGroup.RulerCombined: ImageVector
    get() {
        ...
        _rulerCombined = Builder(name = "RulerCombined", defaultWidth = 448.0.dp, defaultHeight =
                512.0.dp, viewportWidth = 448.0f, viewportHeight = 512.0f).apply {
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                    strokeLineCap = Butt, strokeLineJoin = Miter, strokeLineMiter = 4.0f,
                    pathFillType = NonZero) {
                moveTo(1.0f, 441.7f)
                curveTo(5.5f, 463.5f, 24.8f, 480.0f, 48.0f, 480.0f)
                ...
                lineTo(0.0f, 432.0f)
                curveToRelative(0.0f, 3.3f, 0.3f, 6.6f, 1.0f, 9.7f)
                close()
            }
        }
        .build()

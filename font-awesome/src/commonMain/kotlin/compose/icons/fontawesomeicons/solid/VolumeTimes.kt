...
public val SolidGroup.VolumeTimes: ImageVector
    get() {
        if (_volumeTimes != null) {
            return _volumeTimes!!
        }
        _volumeTimes = Builder(name = "VolumeTimes", defaultWidth = 576.0.dp, defaultHeight =
...
private var _volumeTimes: ImageVector? = null

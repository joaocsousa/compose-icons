...
public val SolidGroup.ProjectDiagram: ImageVector
    get() {
        ...
        _projectDiagram = Builder(name = "ProjectDiagram", defaultWidth = 512.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(-128.0f, 0.0f)
                lineToRelative(0.0f, 16.0f)
                curveToRelative(0.0f, 7.3f, -1.7f, 14.3f, -4.6f, 20.5f)
                lineToRelative(68.6f, 91.5f)

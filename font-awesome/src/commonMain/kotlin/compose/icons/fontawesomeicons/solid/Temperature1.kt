...
public val SolidGroup.Temperature1: ImageVector
    get() {
        if (_temperature1 != null) {
            return _temperature1!!
        }
        _temperature1 = Builder(name = "Temperature1", defaultWidth = 320.0.dp, defaultHeight =
...
private var _temperature1: ImageVector? = null

...
public val SolidGroup.WheelchairAlt: ImageVector
    get() {
        if (_wheelchairAlt != null) {
            return _wheelchairAlt!!
        }
        _wheelchairAlt = Builder(name = "WheelchairAlt", defaultWidth = 448.0.dp, defaultHeight =
...
private var _wheelchairAlt: ImageVector? = null

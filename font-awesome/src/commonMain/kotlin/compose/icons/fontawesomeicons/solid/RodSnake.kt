...
public val SolidGroup.RodSnake: ImageVector
    get() {
        if (_rodSnake != null) {
            return _rodSnake!!
        }
        _rodSnake = Builder(name = "RodSnake", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
...
private var _rodSnake: ImageVector? = null

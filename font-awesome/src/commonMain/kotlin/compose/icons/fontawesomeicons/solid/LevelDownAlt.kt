...
public val SolidGroup.LevelDownAlt: ImageVector
    get() {
        ...
        _levelDownAlt = Builder(name = "LevelDownAlt", defaultWidth = 384.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(332.9f, 320.0f, 320.0f, 320.0f)
                lineToRelative(-64.0f, 0.0f)
                lineToRelative(0.0f, -160.0f)
                curveTo(256.0f, 71.6f, 184.4f, 0.0f, 96.0f, 0.0f)
                lineTo(32.0f, 0.0f)

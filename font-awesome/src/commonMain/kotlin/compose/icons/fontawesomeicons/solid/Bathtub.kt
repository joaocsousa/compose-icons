...
public val SolidGroup.Bathtub: ImageVector
    get() {
        if (_bathtub != null) {
            return _bathtub!!
        }
        _bathtub = Builder(name = "Bathtub", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(-3.6f, 9.1f, -5.5f, 18.9f, -5.5f, 29.2f)
                curveToRelative(0.0f, 19.9f, 7.2f, 38.0f, 19.2f, 52.0f)
                curveToRelative(-5.3f, 9.2f, -4.0f, 21.1f, 3.8f, 29.0f)
                curveToRelative(9.4f, 9.4f, 24.6f, 9.4f, 33.9f, 0.0f)
                lineTo(289.0f, 89.0f)
                curveToRelative(9.4f, -9.4f, 9.4f, -24.6f, 0.0f, -33.9f)
                curveToRelative(-7.8f, -7.9f, -19.8f, -9.1f, -29.0f, -3.8f)
                curveToRelative(-14.0f, -12.0f, -32.1f, -19.2f, -52.0f, -19.2f)

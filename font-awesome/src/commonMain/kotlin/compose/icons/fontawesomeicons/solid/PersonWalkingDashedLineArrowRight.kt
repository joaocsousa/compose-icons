    ...
    get() {
        ...
        _personWalkingDashedLineArrowRight = Builder(name = "PersonWalkingDashedLineArrowRight",
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(28.1f, 182.6f)
                curveTo(10.1f, 200.6f, 0.0f, 225.0f, 0.0f, 250.5f)
                lineTo(0.0f, 288.0f)
                ...
                reflectiveCurveTo(384.0f, -5.3f, 384.0f, 8.0f)
                lineToRelative(0.0f, 32.0f)
                curveToRelative(0.0f, 13.3f, 10.7f, 24.0f, 24.0f, 24.0f)
                reflectiveCurveToRelative(24.0f, -10.7f, 24.0f, -24.0f)
                lineToRelative(0.0f, -32.0f)
                close()
                moveTo(432.0f, 136.0f)
                curveToRelative(0.0f, -13.3f, -10.7f, -24.0f, -24.0f, -24.0f)
                reflectiveCurveToRelative(-24.0f, 10.7f, -24.0f, 24.0f)
                lineToRelative(0.0f, 32.0f)
                curveToRelative(0.0f, 13.3f, 10.7f, 24.0f, 24.0f, 24.0f)

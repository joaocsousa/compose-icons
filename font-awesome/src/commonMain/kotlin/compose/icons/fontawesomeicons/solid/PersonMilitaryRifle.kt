...
public val SolidGroup.PersonMilitaryRifle: ImageVector
    get() {
        ...
        _personMilitaryRifle = Builder(name = "PersonMilitaryRifle", defaultWidth = 448.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineTo(302.7f, 1.4f)
                curveTo(312.0f, 0.7f, 320.0f, 8.0f, 320.0f, 17.4f)
                lineTo(320.0f, 48.0f)

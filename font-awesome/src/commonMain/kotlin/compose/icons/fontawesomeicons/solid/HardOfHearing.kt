...
public val SolidGroup.HardOfHearing: ImageVector
    get() {
        if (_hardOfHearing != null) {
            return _hardOfHearing!!
        }
        _hardOfHearing = Builder(name = "HardOfHearing", defaultWidth = 512.0.dp, defaultHeight =
...
private var _hardOfHearing: ImageVector? = null

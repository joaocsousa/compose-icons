...
public val SolidGroup.ListDots: ImageVector
    get() {
        if (_listDots != null) {
            return _listDots!!
        }
        _listDots = Builder(name = "ListDots", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
...
private var _listDots: ImageVector? = null

...
public val SolidGroup.EarthAmerica: ImageVector
    get() {
        if (_earthAmerica != null) {
            return _earthAmerica!!
        }
        _earthAmerica = Builder(name = "EarthAmerica", defaultWidth = 512.0.dp, defaultHeight =
...
private var _earthAmerica: ImageVector? = null

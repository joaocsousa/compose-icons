...
public val SolidGroup.DesktopAlt: ImageVector
    get() {
        if (_desktopAlt != null) {
            return _desktopAlt!!
        }
        _desktopAlt = Builder(name = "DesktopAlt", defaultWidth = 512.0.dp, defaultHeight =
...
private var _desktopAlt: ImageVector? = null

...
public val SolidGroup.ArrowRightRotate: ImageVector
    get() {
        if (_arrowRightRotate != null) {
            return _arrowRightRotate!!
        }
        _arrowRightRotate = Builder(name = "ArrowRightRotate", defaultWidth = 512.0.dp,
...
private var _arrowRightRotate: ImageVector? = null

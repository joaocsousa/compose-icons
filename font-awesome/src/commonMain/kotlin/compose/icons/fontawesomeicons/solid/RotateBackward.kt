...
public val SolidGroup.RotateBackward: ImageVector
    get() {
        if (_rotateBackward != null) {
            return _rotateBackward!!
        }
        _rotateBackward = Builder(name = "RotateBackward", defaultWidth = 512.0.dp, defaultHeight =
...
private var _rotateBackward: ImageVector? = null

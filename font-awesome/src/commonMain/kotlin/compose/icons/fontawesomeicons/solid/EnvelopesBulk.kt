    ...
    get() {
        ...
        _envelopesBulk = Builder(name = "EnvelopesBulk", defaultWidth = 576.0.dp, defaultHeight =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                lineToRelative(156.6f, 86.2f)
                curveToRelative(1.1f, 0.6f, 2.2f, 0.9f, 3.4f, 0.9f)
                reflectiveCurveToRelative(2.4f, -0.3f, 3.4f, -0.9f)
                lineTo(320.0f, 314.4f)
                lineTo(320.0f, 304.0f)
                curveToRelative(0.0f, -26.5f, -21.5f, -48.0f, -48.0f, -48.0f)
                lineTo(48.0f, 256.0f)
                close()
                moveTo(320.0f, 369.2f)
                lineTo(186.6f, 442.6f)
                curveToRelative(-8.1f, 4.5f, -17.3f, 6.8f, -26.6f, 6.8f)
                reflectiveCurveToRelative(-18.4f, -2.4f, -26.6f, -6.8f)
                lineTo(0.0f, 369.2f)
                lineTo(0.0f, 464.0f)
                curveToRelative(0.0f, 26.5f, 21.5f, 48.0f, 48.0f, 48.0f)

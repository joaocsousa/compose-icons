    ...
    get() {
        ...
        _maximize = Builder(name = "Maximize", defaultWidth = 448.0.dp, defaultHeight = 512.0.dp,
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                reflectiveCurveTo(34.1f, 223.8f, 41.0f, 217.0f)
                ...
                reflectiveCurveTo(270.3f, 480.0f, 280.0f, 480.0f)
                lineToRelative(144.0f, 0.0f)
                ...
                lineToRelative(40.0f, 40.0f)
                curveToRelative(6.9f, 6.9f, 17.2f, 8.9f, 26.2f, 5.2f)
                reflectiveCurveTo(448.0f, 209.7f, 448.0f, 200.0f)
                lineToRelative(0.0f, -144.0f)
                curveToRelative(0.0f, -13.3f, -10.7f, -24.0f, -24.0f, -24.0f)
                lineTo(280.0f, 32.0f)
                curveToRelative(-9.7f, 0.0f, -18.5f, 5.8f, -22.2f, 14.8f)
                reflectiveCurveTo(256.2f, 66.1f, 263.0f, 73.0f)
                lineToRelative(40.0f, 40.0f)
                lineToRelative(-79.0f, 79.0f)
                lineToRelative(-79.0f, -79.0f)
                lineToRelative(40.0f, -40.0f)

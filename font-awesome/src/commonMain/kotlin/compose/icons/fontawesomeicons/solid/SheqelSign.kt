...
public val SolidGroup.SheqelSign: ImageVector
    get() {
        if (_sheqelSign != null) {
            return _sheqelSign!!
        }
        _sheqelSign = Builder(name = "SheqelSign", defaultWidth = 448.0.dp, defaultHeight =
...
private var _sheqelSign: ImageVector? = null

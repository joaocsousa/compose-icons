...
public val SolidGroup.RotateBack: ImageVector
    get() {
        if (_rotateBack != null) {
            return _rotateBack!!
        }
        _rotateBack = Builder(name = "RotateBack", defaultWidth = 512.0.dp, defaultHeight =
...
private var _rotateBack: ImageVector? = null

...
public val SolidGroup.GaugeMed: ImageVector
    get() {
        if (_gaugeMed != null) {
            return _gaugeMed!!
        }
        _gaugeMed = Builder(name = "GaugeMed", defaultWidth = 512.0.dp, defaultHeight = 512.0.dp,
...
private var _gaugeMed: ImageVector? = null

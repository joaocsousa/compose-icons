    ...
    get() {
        ...
        _assistiveListeningSystems = Builder(name = "AssistiveListeningSystems", defaultWidth =
            ...
            path(fill = SolidColor(Color(0xFF000000)), stroke = null, strokeLineWidth = 0.0f,
                ...
                moveTo(379.6f, 0.3f)
                curveToRelative(-8.9f, 1.2f, -17.2f, 6.2f, -22.4f, 14.1f)
                curveToRelative(-6.8f, 10.4f, -7.0f, 24.1f, -0.4f, 34.6f)
                curveToRelative(5.6f, 8.9f, 15.5f, 12.7f, 23.8f, 18.5f)
                curveToRelative(7.5f, 5.2f, 17.6f, 13.2f, 27.7f, 24.2f)
                curveToRelative(20.0f, 21.7f, 39.5f, 54.3f, 39.5f, 100.3f)
                curveToRelative(0.0f, 17.7f, 14.3f, 32.0f, 32.0f, 32.0f)
                reflectiveCurveToRelative(32.0f, -14.3f, 32.0f, -32.0f)
                curveToRelative(0.0f, -66.0f, -28.5f, -113.4f, -56.5f, -143.7f)
                curveToRelative(-13.9f, -15.1f, -27.8f, -26.1f, -38.3f, -33.3f)
                curveToRelative(-11.0f, -7.6f, -23.5f, -16.6f, -37.6f, -14.7f)
                close()
                ...
                curveToRelative(9.7f, -88.0f, 84.3f, -156.5f, 174.9f, -156.5f)
